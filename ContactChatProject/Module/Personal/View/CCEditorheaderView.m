...
@implementation CCEditorheaderView
...
-(CCEditorimageView *)imgView0
{
    if(!_imgView0)
    {
        _imgView0 = [[CCEditorimageView alloc] init];
...
-(CCEditorimageView *)imgView1
{
    if(!_imgView1)
    {
        _imgView1 = [[CCEditorimageView alloc] init];
...
-(CCEditorimageView *)imgView2
{
    if(!_imgView2)
    {
        _imgView2 = [[CCEditorimageView alloc] init];
...
-(CCEditorimageView *)imgView3
{
    if(!_imgView3)
    {
        _imgView3 = [[CCEditorimageView alloc] init];
...
-(CCEditorimageView *)imgView4
{
    if(!_imgView4)
    {
        _imgView4 = [[CCEditorimageView alloc] init];
...
-(CCEditorimageView *)imgView5
{
    if(!_imgView5)
    {
        _imgView5 = [[CCEditorimageView alloc] init];
