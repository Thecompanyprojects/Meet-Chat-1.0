...
@implementation CCChoosesexView
...
-(UIButton *)chooseboyBtn
{
    if(!_chooseboyBtn)
    {
        ...
        [_chooseboyBtn setImage:[UIImage imageNamed:@"nan"] forState:normal];
...
-(UIButton *)choosegirlBtn
{
    if(!_choosegirlBtn)
    {
        ...
        [_choosegirlBtn setImage:[UIImage imageNamed:@"nv2"] forState:normal];
...
//    [[XYLogManager shareManager] addLogKey1:@"sex" key2:@"click" content:@{@"result":@(0)} userInfo:[NSDictionary new] upload:YES];
    self.sex = @"f";
    [self.chooseboyBtn setImage:[UIImage imageNamed:@"nan2"] forState:normal];
    [self.choosegirlBtn setImage:[UIImage imageNamed:@"nv2"] forState:normal];
