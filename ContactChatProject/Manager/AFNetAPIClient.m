...
+ (instancetype)sharedClient {
    ...
    [_sharedClient.requestSerializer setValue:[NSString stringWithFormat:@"Bearer %@",[CCUserModel sharedUserModel].token ? [CCUserModel sharedUserModel].token:@""]  forHTTPHeaderField:@"Authorization"];
