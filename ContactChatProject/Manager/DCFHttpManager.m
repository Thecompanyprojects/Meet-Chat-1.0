...
{
    NSDictionary *parameters = @{@"id":@([[CCUserModel sharedUserModel].userId intValue])};
        ...
        if (data_dec) {
            ...
            if (!serializeError) {
                ...
                if (success) {
                    ...
                    [CCUserModel sharedUserModel].token = token;
                    [CCUserModel sharedUserModel].refreshtoken = refreshtoken;
